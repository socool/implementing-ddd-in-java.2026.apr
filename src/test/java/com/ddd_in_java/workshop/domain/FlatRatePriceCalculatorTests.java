...
class FlatRatePriceCalculatorTests {
    ...
    void calculatesPrice_forGreenWaste() {
        ...
        var fraction = new DroppedFraction(FractionType.fromString("Green waste", "Oak City"), new Weight(83));
    ...
    void calculatesPrice_forConstructionWaste() {
        ...
        var fraction = new DroppedFraction(FractionType.fromString("Construction waste", "Oak City"), new Weight(18));
